...
export const wgsl = (text: HLJSApi) => ({
  ...
  illegal: '"',
  contains: [
    text.C_LINE_COMMENT_MODE,
    text.C_BLOCK_COMMENT_MODE,
    text.C_NUMBER_MODE,
  ],
});
