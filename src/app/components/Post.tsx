...
const Post = ({ post, base }: PostProps) => {
  ...
  return (
    <div className="container m-auto max-w-4xl rounded max-sm:rounded-none p-4 font-mono bg-white dark:bg-slate-950 shadow">
      ...
      <div
        className="markdown-body font-mono pt-4 dark:bg-slate-950"
